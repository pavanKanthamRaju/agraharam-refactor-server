...
router.post(
  "/",
  validateRequest({ body: createPoojaItemSchema }),
  asyncHandler(createPoojaItem)
);

router.get(
  "/",
  asyncHandler(getPoojaItems)
);

router.get(
  "/:pooja_id",
  validateRequest({ params: poojaIdParamSchema }),
  asyncHandler(getPoojaItemsById)
);

router.put(
  "/:id",
  validateRequest({ params: idParamSchema, body: updatePoojaItemSchema }),
  asyncHandler(updatePoojaItemById)
);

router.delete(
  "/:id",
  validateRequest({ params: idParamSchema }),
  asyncHandler(deletePoojaItemById)
);
