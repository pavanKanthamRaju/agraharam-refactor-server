...
router.post(
  "/",
  validateRequest({ body: createPoojaNivedyamSchema }),
  asyncHandler(createPoojaNivedyam)
);

router.get(
  "/",
  asyncHandler(getPoojaNivedyams)
);

router.get(
  "/:pooja_id",
  validateRequest({ params: poojaIdParamSchema }),
  asyncHandler(getPoojaNivedyamsById)
);

router.put(
  "/:id",
  validateRequest({ params: idParamSchema, body: updatePoojaNivedyamSchema }),
  asyncHandler(updatePoojaNivedyamById)
);

router.delete(
  "/:id",
  validateRequest({ params: idParamSchema }),
  asyncHandler(deletePoojaNivedyamById)
);
