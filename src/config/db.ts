 ...
 */
const createSupabaseAdapter = (): DbAdapter => {
 ...
 */
const createPgAdapter = (): DbAdapter => {
    const pool = new Pool({
...
const db: DbAdapter = isProd ? createSupabaseAdapter() : createPgAdapter();
