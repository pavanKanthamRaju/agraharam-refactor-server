...
export const askRagData = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
...
export const createAndStoreEmbedding = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
