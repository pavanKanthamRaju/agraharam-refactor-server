...
const addNivedyam = async (req: Request, res: Response): Promise<void> => {
    try {
...
const getNivedyams = async (req: Request, res: Response): Promise<void> => {
    try {
...
const updateNivedyamController = async (req: Request, res: Response): Promise<void> => {
    try {
        const { id } = req.params;
        const { nivedyam_name, description, category_id, price, unit, image_url } = req.body;
...
const deleteNivedyamController = async (req: Request, res: Response): Promise<void> => {
    try {
        const { id } = req.params;
