...
const getNivedyamByPooja = async (pooja_id) => {
    const result = await db.query(`
...
const addPoojaNivedyam = async (data) => {
...
const updatePoojaNivedyam = async (id, data) => {
...
//# sourceMappingURL=poojaNivedyamModel.js.map