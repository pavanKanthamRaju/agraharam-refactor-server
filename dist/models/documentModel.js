...
export const storeDocument = async (fileName, path) => {
    const result = await db.query(`INSERT INTO documents (file_name, path)
        VALUES($1,$2)
...
export const storeChunks = async (documentId, index, content, embedding) => {
    ...
    await db.query(`INSERT INTO document_chunks
        (document_id, chunk_index, content, embedding)
        VALUES($1,$2,$3,$4)`, [documentId, index, content, vector]);
};
