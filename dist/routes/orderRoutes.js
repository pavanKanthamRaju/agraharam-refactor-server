...
// Routes
router.post("/", validateRequest({ body: placeOrderSchema }), asyncHandler(placeOrder));
router.get("/getAllOrders", asyncHandler(getAllOrders));
router.get("/:user_id", validateRequest({ params: userIdParamSchema }), asyncHandler(getUserOrders));
